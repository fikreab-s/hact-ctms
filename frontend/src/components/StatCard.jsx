export default function StatCard({ title, value, subtitle, icon: Icon, variant = 'primary' }) {
  ...
  return (
    <div className={`${variants[variant]} rounded-xl p-4 sm:p-5 text-white shadow-lg relative overflow-hidden`}>
      {/* Decorative circle */}
      ...
      <div className="relative">
        <div className="flex items-center justify-between mb-2 sm:mb-3">
          ...
          {Icon && <Icon className="w-4 h-4 sm:w-5 sm:h-5 text-white/60" />}
        </div>
